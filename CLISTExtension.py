...
class CLISTExtension(cast.analysers.ua.Extension):

    def __init__(self):        
        self.extensions = ['.clist']
        self.active = False
        self.nbpgmCreated = 0
    ...
    def start_file(self,file):  
        ...
        if ext.lower() in self.extensions:
            ...
            log.info("Parsing CLIST file %s..." % file)
            ...
            with open_source_file(file.get_path()) as srcfile1:
                ...
                self.obj = self.__create_object(self,obj_name, "CLISTProgram", self.file, self.filepath, obj_bookmark)
                self.nbpgmCreated += 1
    ...
    def end_analysis(self):
        ...
        log.info("*****************************************************************")
        log.info(" Total CLIST Program Objects Created  -- > " + str(self.nbpgmCreated))
        log.info("*****************************************************************")
